class Color::MapSupplierProductsColorsJob < ApplicationJob
  include Emailable
  ...
  def perform(job_id)
    ...
    begin
      ...
      product_count = supplier.assign_supplier_products_to_platform_color_options!

      subject = "[Color Mapping] Processed #{product_count} products"
      ...
      puts 'Finished mapping all the colors!'.green
    rescue => ex
      puts "#{ex}".red
      Rollbar.error(ex,
