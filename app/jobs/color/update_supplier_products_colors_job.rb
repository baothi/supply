class Color::UpdateSupplierProductsColorsJob < ApplicationJob
  include Emailable
  ...
  def perform(job_id)
    ...
    begin
      ...
      supplier.create_colors_from_option_types!

      subject = "[Color Options] Processed ~ #{supplier.products.count} products"
