...
ActiveRecord::Schema.define(version: 20210104080452) do
  ...
  create_table "spree_assets", force: :cascade do |t|
    ...
    t.index ["hash_value"], name: "index_spree_assets_on_hash_value", using: :btree
  ...
  create_table "spree_category_option_matches", force: :cascade do |t|
    t.integer  "supplier_id",                 null: false
    t.integer  "platform_category_option_id", null: false
    t.integer  "supplier_category_option_id", null: false
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
    t.index ["platform_category_option_id", "supplier_category_option_id"], name: "spree_category_option_matches_on_platform_and_supplier_category", unique: true, using: :btree
    t.index ["supplier_id"], name: "index_spree_category_option_matches_on_supplier_id", using: :btree
  end
  ...
  create_table "spree_couriers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_spree_couriers_on_code", using: :btree
    t.index ["name"], name: "index_spree_couriers_on_name", using: :btree
  end
  ...
  create_table "spree_edi_fulfillment_notices", force: :cascade do |t|
    t.string   "asn_number"
  ...
  create_table "spree_favorites", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["product_id"], name: "index_spree_favorites_on_product_id", using: :btree
    t.index ["retailer_id"], name: "index_spree_favorites_on_retailer_id", using: :btree
  end

  create_table "spree_featured_banners", force: :cascade do |t|
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["internal_identifier"], name: "index_spree_featured_banners_on_internal_identifier", using: :btree
    t.index ["taxon_id"], name: "index_spree_featured_banners_on_taxon_id", using: :btree
  end
  ...
  create_table "spree_groupings", force: :cascade do |t|
    t.string   "internal_identifier"
    t.string   "name"
    t.text     "description"
    t.string   "group_type"
    ...
    t.index ["internal_identifier"], name: "index_spree_groupings_on_internal_identifier", using: :btree
    t.index ["mini_identifier"], name: "index_spree_groupings_on_mini_identifier", unique: true, using: :btree
    t.index ["slug"], name: "index_spree_groupings_on_slug", unique: true, using: :btree
  end
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.index ["internal_identifier"], name: "index_spree_line_items_on_internal_identifier", using: :btree
  ...
  create_table "spree_long_running_jobs", force: :cascade do |t|
    t.integer  "retailer_id"
    t.integer  "supplier_id"
    t.integer  "user_id"
    ...
    t.index ["internal_identifier"], name: "index_spree_long_running_jobs_on_internal_identifier", using: :btree
    ...
    t.index ["retailer_id"], name: "index_spree_long_running_jobs_on_retailer_id", using: :btree
    t.index ["supplier_id"], name: "index_spree_long_running_jobs_on_supplier_id", using: :btree
    t.index ["teamable_type", "teamable_id"], name: "index_spree_long_running_jobs_on_teamable_type_and_teamable_id", using: :btree
    t.index ["user_id"], name: "index_spree_long_running_jobs_on_user_id", using: :btree
  end

  create_table "spree_mapped_shipping_methods", force: :cascade do |t|
    t.string   "teamable_type"
    t.integer  "teamable_id"
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["shipping_method_id"], name: "index_spree_mapped_shipping_methods_on_shipping_method_id", using: :btree
    t.index ["teamable_type", "teamable_id", "shipping_method_id"], name: "index_on_teamable_and_method_on_mapped_shipping_methods", unique: true, using: :btree
    t.index ["teamable_type", "teamable_id"], name: "index_on_teamable_for_mapped_shipping_methods", using: :btree
  end
  ...
  create_table "spree_order_invoices", force: :cascade do |t|
    ...
    t.integer  "retailer_id"
    t.integer  "supplier_id"
    t.index ["order_id"], name: "index_spree_order_invoices_on_order_id", using: :btree
  end

  create_table "spree_order_issue_reports", force: :cascade do |t|
    t.integer  "order_id"
    t.text     "description"
    t.string   "resolution"
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["order_id"], name: "index_spree_order_issue_reports_on_order_id", using: :btree
  end
  ...
  create_table "spree_order_risks", force: :cascade do |t|
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["order_id"], name: "index_spree_order_risks_on_order_id", using: :btree
  end
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.index ["auto_paid_at"], name: "index_spree_orders_on_auto_paid_at", using: :btree
    ...
    t.index ["internal_identifier"], name: "index_spree_orders_on_internal_identifier", using: :btree
    t.index ["number"], name: "index_spree_orders_on_number", using: :btree
    t.index ["retailer_id"], name: "index_spree_orders_on_retailer_id", using: :btree
    t.index ["retailer_shopify_name"], name: "index_spree_orders_on_retailer_shopify_name", using: :btree
    t.index ["retailer_shopify_number"], name: "index_spree_orders_on_retailer_shopify_number", using: :btree
    t.index ["retailer_shopify_order_number"], name: "index_spree_orders_on_retailer_shopify_order_number", using: :btree
    t.index ["ship_address_id"], name: "index_spree_orders_on_ship_address_id", using: :btree
    t.index ["shopify_sent_at"], name: "index_spree_orders_on_shopify_sent_at", using: :btree
    t.index ["store_id"], name: "index_spree_orders_on_store_id", using: :btree
    t.index ["supplier_id"], name: "index_spree_orders_on_supplier_id", using: :btree
    t.index ["supplier_shopify_number"], name: "index_spree_orders_on_supplier_shopify_number", using: :btree
    t.index ["supplier_shopify_order_name"], name: "index_spree_orders_on_supplier_shopify_order_name", using: :btree
    t.index ["supplier_shopify_order_number"], name: "index_spree_orders_on_supplier_shopify_order_number", using: :btree
  ...
  create_table "spree_platform_category_options", force: :cascade do |t|
    t.string   "name",                            null: false
    t.string   "presentation"
    t.integer  "parent_id"
    t.integer  "position",            default: 0
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.index ["internal_identifier"], name: "index_spree_platform_category_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_platform_category_options_on_name", using: :btree
  end

  create_table "spree_platform_color_options", force: :cascade do |t|
    t.string   "name",                            null: false
    t.string   "presentation"
    t.integer  "parent_id"
    t.string   "hex_code"
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.index ["internal_identifier"], name: "index_spree_platform_color_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_platform_color_options_on_name", using: :btree
  end

  create_table "spree_platform_features", force: :cascade do |t|
    t.string   "plan_name"
  ...
  create_table "spree_platform_size_options", force: :cascade do |t|
    t.string   "name",                            null: false
    t.string   "presentation"
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.index ["internal_identifier"], name: "index_spree_platform_size_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_platform_size_options_on_name", using: :btree
    t.index ["name_1"], name: "index_spree_platform_size_options_on_name_1", using: :btree
  end
  ...
  create_table "spree_product_export_processes", force: :cascade do |t|
    t.integer  "product_id"
    t.integer  "retailer_id"
    t.string   "status"
    t.datetime "created_at",  null: false
    ...
    t.text     "log"
    t.text     "error_log"
    t.index ["product_id"], name: "index_spree_product_export_processes_on_product_id", using: :btree
    t.index ["retailer_id"], name: "index_spree_product_export_processes_on_retailer_id", using: :btree
  end

  create_table "spree_product_listings", force: :cascade do |t|
    ...
    t.index ["internal_identifier"], name: "index_spree_product_listings_on_internal_identifier", using: :btree
    t.index ["product_id"], name: "index_spree_product_listings_on_product_id", using: :btree
    t.index ["retailer_id", "supplier_id", "product_id"], name: "index_product_listing_retailer_supplier_product_id", unique: true, using: :btree
    t.index ["retailer_id"], name: "index_spree_product_listings_on_retailer_id", using: :btree
    t.index ["style_identifier"], name: "index_spree_product_listings_on_style_identifier", using: :btree
    t.index ["supplier_id"], name: "index_spree_product_listings_on_supplier_id", using: :btree
  end
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.index ["dsco_identifier"], name: "index_spree_products_on_dsco_identifier", using: :btree
    t.index ["internal_identifier"], name: "index_spree_products_on_internal_identifier", using: :btree
    ...
    t.index ["shopify_identifier"], name: "index_spree_products_on_shopify_identifier", using: :btree
    ...
    t.index ["vendor_style_identifier"], name: "index_spree_products_on_vendor_style_identifier", using: :btree
  end
  ...
  create_table "spree_refund_records", force: :cascade do |t|
    t.integer  "refund_id"
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["refund_id"], name: "index_spree_refund_records_on_refund_id", using: :btree
  end
  ...
  create_table "spree_reseller_agreements", force: :cascade do |t|
    t.integer  "retailer_id"
    t.integer  "supplier_id"
    ...
    t.datetime "created_at",                                null: false
    t.datetime "updated_at",                                null: false
    t.index ["retailer_id"], name: "index_spree_reseller_agreements_on_retailer_id", using: :btree
    t.index ["retailer_signer_identifier"], name: "index_spree_reseller_agreements_on_retailer_signer_identifier", using: :btree
    t.index ["supplier_id"], name: "index_spree_reseller_agreements_on_supplier_id", using: :btree
    t.index ["supplier_signer_identifier"], name: "index_spree_reseller_agreements_on_supplier_signer_identifier", using: :btree
  end

  create_table "spree_retail_connections", force: :cascade do |t|
    t.integer  "retailer_id",                        null: false
    t.integer  "supplier_id",                        null: false
    ...
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
    t.index ["retailer_id"], name: "index_spree_retail_connections_on_retailer_id", using: :btree
    t.index ["supplier_id", "retailer_id"], name: "index_spree_retail_connections_on_supplier_id_and_retailer_id", unique: true, using: :btree
    t.index ["supplier_id"], name: "index_spree_retail_connections_on_supplier_id", using: :btree
  end

  create_table "spree_retailer_credits", force: :cascade do |t|
    t.integer  "retailer_id"
    t.decimal  "by_supplier"
    t.decimal  "by_hingeto"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["retailer_id"], name: "index_spree_retailer_credits_on_retailer_id", using: :btree
  end

  create_table "spree_retailer_inventories", force: :cascade do |t|
    t.integer  "retailer_id"
    t.jsonb    "inventory",         default: "{}", null: false
    t.datetime "last_generated_at"
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.index ["retailer_id"], name: "index_spree_retailer_inventories_on_retailer_id", unique: true, using: :btree
  end

  create_table "spree_retailer_order_reports", force: :cascade do |t|
    t.integer  "retailer_id"
    t.integer  "supplier_id"
    t.string   "source"
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.index ["retailer_id"], name: "index_spree_retailer_order_reports_on_retailer_id", using: :btree
    t.index ["supplier_id"], name: "index_spree_retailer_order_reports_on_supplier_id", using: :btree
  end

  create_table "spree_retailer_platform_features", force: :cascade do |t|
    t.string   "plan_name"
    t.string   "stripe_plan_identifier"
    t.jsonb    "settings",               default: {}, null: false
    t.boolean  "active"
  ...
  create_table "spree_retailer_referrals", force: :cascade do |t|
    t.string   "name"
    t.string   "string"
    t.string   "url"
    t.string   "email"
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["spree_supplier_id"], name: "index_spree_retailer_referrals_on_spree_supplier_id", using: :btree
  end

  create_table "spree_retailers", force: :cascade do |t|
    t.string   "name",                                                        null: false
    t.string   "slug",                                                        null: false
    ...
    t.string   "app_name"
    t.index ["email"], name: "index_spree_retailers_on_email", using: :btree
    t.index ["internal_identifier"], name: "index_spree_retailers_on_internal_identifier", unique: true, using: :btree
    t.index ["shopify_url"], name: "index_spree_retailers_on_shopify_url", using: :btree
    t.index ["slug"], name: "index_spree_retailers_on_slug", unique: true, using: :btree
  end
  ...
  create_table "spree_selling_authorities", force: :cascade do |t|
    t.integer  "retailer_id"
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["permittable_type", "permittable_id"], name: "index_on_permittable_type_id", using: :btree
    t.index ["retailer_id", "permittable_id", "permittable_type"], name: "index_spree_selling_authorities_on_retailer_and_permittable", unique: true, using: :btree
    t.index ["retailer_id"], name: "index_spree_selling_authorities_on_retailer_id", using: :btree
  end

  create_table "spree_sftp_credentials", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["teamable_type", "teamable_id"], name: "index_on_teamable_for_sftp_credentials", using: :btree
  end
  ...
  create_table "spree_shipping_zone_eligibilities", force: :cascade do |t|
    t.integer  "supplier_id"
    t.integer  "zone_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["supplier_id", "zone_id"], name: "index_spree_shipping_zone_eligibilities_on_supplier_zone_id", using: :btree
    t.index ["supplier_id"], name: "index_spree_shipping_zone_eligibilities_on_supplier_id", using: :btree
    t.index ["zone_id"], name: "index_spree_shipping_zone_eligibilities_on_zone_id", using: :btree
  end

  create_table "spree_shopify_credentials", force: :cascade do |t|
    t.string   "store_url"
    ...
    t.index ["teamable_type", "teamable_id"], name: "index_on_teamable_for_shopify_credentials", using: :btree
  end

  create_table "spree_special_variant_costs", force: :cascade do |t|
    t.integer  "supplier_id",                                       null: false
    t.integer  "retailer_id"
    ...
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
    t.index ["retailer_id"], name: "index_spree_special_variant_costs_on_retailer_id", using: :btree
    t.index ["supplier_id", "retailer_id", "sku"], name: "index_on_spree_special_variant_costs_on_supplier_retailer_sku", unique: true, using: :btree
    t.index ["supplier_id"], name: "index_spree_special_variant_costs_on_supplier_id", using: :btree
  end
  ...
  create_table "spree_stock_item_trackings", force: :cascade do |t|
    t.integer  "stock_item_id"
    t.integer  "product_id"
    t.string   "state"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["product_id"], name: "index_spree_stock_item_trackings_on_product_id", using: :btree
    t.index ["stock_item_id"], name: "index_spree_stock_item_trackings_on_stock_item_id", using: :btree
  end
  ...
  create_table "spree_supplier_category_options", force: :cascade do |t|
    t.integer  "supplier_id",                             null: false
    t.string   "name",                                    null: false
    t.string   "presentation"
    t.integer  "position",                    default: 0
    ...
    t.datetime "updated_at",                              null: false
    t.integer  "platform_category_option_id"
    t.index ["internal_identifier"], name: "index_spree_supplier_category_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_supplier_category_options_on_name", using: :btree
    t.index ["supplier_id", "name"], name: "index_spree_supplier_category_options_on_supplier_id_and_name", unique: true, using: :btree
    t.index ["supplier_id"], name: "index_spree_supplier_category_options_on_supplier_id", using: :btree
  end

  create_table "spree_supplier_color_options", force: :cascade do |t|
    t.integer  "supplier_id",                          null: false
    t.string   "name",                                 null: false
    t.string   "presentation"
    t.integer  "position",                 default: 0
    ...
    t.index ["internal_identifier"], name: "index_spree_supplier_color_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_supplier_color_options_on_name", using: :btree
    t.index ["supplier_id", "name"], name: "index_spree_supplier_color_options_on_supplier_id_and_name", unique: true, using: :btree
    t.index ["supplier_id"], name: "index_spree_supplier_color_options_on_supplier_id", using: :btree
  end

  create_table "spree_supplier_license_options", force: :cascade do |t|
    t.integer  "supplier_id",                          null: false
    t.string   "name",                                 null: false
    t.string   "presentation"
    t.integer  "position",                 default: 0
    ...
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.index ["internal_identifier"], name: "index_spree_supplier_license_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_supplier_license_options_on_name", using: :btree
    t.index ["supplier_id"], name: "index_spree_supplier_license_options_on_supplier_id", using: :btree
  end

  create_table "spree_supplier_platform_features", force: :cascade do |t|
    t.string   "plan_name"
    t.string   "stripe_plan_identifier"
    t.jsonb    "settings",               default: {}, null: false
    t.boolean  "active"
  ...
  create_table "spree_supplier_referrals", force: :cascade do |t|
    t.string   "name"
    t.string   "string"
    t.string   "url"
    t.string   "email"
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["spree_retailer_id"], name: "index_spree_supplier_referrals_on_spree_retailer_id", using: :btree
  end

  create_table "spree_supplier_size_options", force: :cascade do |t|
    t.integer  "supplier_id",                         null: false
    t.string   "name",                                null: false
    t.string   "presentation"
    t.integer  "position",                default: 0
    ...
    t.index ["internal_identifier"], name: "index_spree_supplier_size_options_on_internal_identifier", using: :btree
    t.index ["name"], name: "index_spree_supplier_size_options_on_name", using: :btree
    t.index ["supplier_id"], name: "index_spree_supplier_size_options_on_supplier_id", using: :btree
  end
  ...
  create_table "spree_suppliers", force: :cascade do |t|
    ...
    t.datetime "onboarding_session_at"
    t.string   "current_shopify_subscription_identifier"
    t.index ["email"], name: "index_spree_suppliers_on_email", using: :btree
    t.index ["internal_identifier"], name: "index_spree_suppliers_on_internal_identifier", unique: true, using: :btree
    t.index ["shopify_url"], name: "index_spree_suppliers_on_shopify_url", using: :btree
  ...
  create_table "spree_taxon_groupings", force: :cascade do |t|
    t.integer  "taxon_id"
    t.integer  "grouping_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["grouping_id"], name: "index_spree_taxon_groupings_on_grouping_id", using: :btree
    t.index ["taxon_id"], name: "index_spree_taxon_groupings_on_taxon_id", using: :btree
  end
  ...
  create_table "spree_taxons", force: :cascade do |t|
    ...
    t.integer  "supplier_id"
    t.integer  "retailer_id"
    t.index ["google_category_id"], name: "index_spree_taxons_on_google_category_id", using: :btree
    t.index ["google_category_nested_string"], name: "index_spree_taxons_on_google_category_nested_string", using: :btree
    t.index ["lft"], name: "index_spree_taxons_on_lft", using: :btree
    t.index ["mini_identifier"], name: "index_spree_taxons_on_mini_identifier", unique: true, using: :btree
    ...
    t.index ["slug"], name: "index_spree_taxons_on_slug", unique: true, using: :btree
    t.index ["taxonomy_id"], name: "index_taxons_on_taxonomy_id", using: :btree
  end

  create_table "spree_team_members", force: :cascade do |t|
    t.string   "teamable_type"
    t.integer  "teamable_id"
    t.integer  "user_id"
    t.integer  "role_id"
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["role_id"], name: "index_spree_team_members_on_role_id", using: :btree
    t.index ["teamable_type", "teamable_id"], name: "index_spree_team_members_on_teamable_type_and_teamable_id", using: :btree
    t.index ["user_id"], name: "index_spree_team_members_on_user_id", using: :btree
  end
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.index ["email", "shopify_slug"], name: "index_spree_users_on_email_and_shopify_slug", unique: true, using: :btree
    t.index ["email", "shopify_url"], name: "index_spree_users_on_email_and_shopify_url", unique: true, using: :btree
  ...
  create_table "spree_variant_costs", force: :cascade do |t|
    t.integer  "supplier_id",                                       null: false
    t.string   "sku",                                               null: false
    t.string   "msrp_currency",                     default: "USD"
    t.decimal  "msrp",                                              null: false
    ...
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
    t.index ["supplier_id", "sku"], name: "index_on_spree_variant_costs_on_supplier_retailer_sku", unique: true, using: :btree
    t.index ["supplier_id"], name: "index_spree_variant_costs_on_supplier_id", using: :btree
  end

  create_table "spree_variant_listings", force: :cascade do |t|
    t.integer  "retailer_id",                               null: false
    t.integer  "supplier_id",                               null: false
    t.integer  "variant_id",                                null: false
    ...
    t.datetime "shopify_management_switched_to_hingeto_at"
    t.index ["internal_identifier"], name: "index_spree_variant_listings_on_internal_identifier", using: :btree
    t.index ["product_listing_id"], name: "index_spree_variant_listings_on_product_listing_id", using: :btree
    t.index ["retailer_id", "supplier_id", "variant_id"], name: "index_retailer_supplier_variant_id", unique: true, using: :btree
    t.index ["retailer_id"], name: "index_spree_variant_listings_on_retailer_id", using: :btree
    t.index ["supplier_id"], name: "index_spree_variant_listings_on_supplier_id", using: :btree
    t.index ["variant_id"], name: "index_spree_variant_listings_on_variant_id", using: :btree
  end
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.index ["barcode"], name: "index_spree_variants_on_barcode", using: :btree
    ...
    t.index ["dsco_identifier"], name: "index_spree_variants_on_dsco_identifier", using: :btree
    t.index ["gtin"], name: "index_spree_variants_on_gtin", using: :btree
    t.index ["internal_identifier"], name: "index_spree_variants_on_internal_identifier", using: :btree
    t.index ["is_master"], name: "index_spree_variants_on_is_master", using: :btree
    t.index ["original_supplier_sku"], name: "index_spree_variants_on_original_supplier_sku", using: :btree
    t.index ["platform_supplier_sku"], name: "index_spree_variants_on_platform_supplier_sku", using: :btree
    ...
    t.index ["shopify_identifier"], name: "index_spree_variants_on_shopify_identifier", using: :btree
    ...
    t.index ["upc"], name: "index_spree_variants_on_upc", using: :btree
  end

  create_table "spree_webhooks", force: :cascade do |t|
    t.string   "address"
    t.string   "topic"
    t.string   "shopify_identifier"
    t.integer  "teamable_id"
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["teamable_type", "teamable_id"], name: "index_spree_webhooks_on_teamable_type_and_teamable_id", using: :btree
  end
  ...
  create_table "stripe_customers", force: :cascade do |t|
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["strippable_type", "strippable_id"], name: "index_stripe_customers_on_strippable_type_and_strippable_id", using: :btree
  end
  ...
  create_table "stripe_events", force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["stripe_eventable_type", "stripe_eventable_id"], name: "index_on_type_and_id", using: :btree
  end
  ...
  create_table "stripe_invoices", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["stripe_customer_id"], name: "index_stripe_invoices_on_stripe_customer_id", using: :btree
  end
  ...
  create_table "stripe_subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["stripe_customer_id"], name: "index_stripe_subscriptions_on_stripe_customer_id", using: :btree
    t.index ["stripe_plan_id"], name: "index_stripe_subscriptions_on_stripe_plan_id", using: :btree
  end

  create_table "variant_cost_versions", force: :cascade do |t|
    ...
    t.index ["item_type", "item_id"], name: "index_variant_cost_versions_on_item_type_and_item_id", using: :btree
  end
