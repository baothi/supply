...
ActiveAdmin.setup do |config|
  ...
  config.comments_menu = { priority: 2 }
    ...
    def build_download_format_links(formats = self.class.formats)
      ...
      div class: 'download_links' do
        ...
        formats.each do |format|
          if format == :csv_email
            params[:resource_class] = controller.controller_name
            a('Download for Email', href: admin_dashboard_export_csv_as_email_path(params: params))
          else
